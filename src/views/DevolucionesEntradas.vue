    ...
    <q-table title="DEVOLUCIONES ENTRADAS" :rows="rows" :columns="columns" row-key="name" class="tabla">
      ...
      <template v-slot:body-cell-Opciones="props">
        <q-td :props="props" class="q-pa-sm">
          ...
          console.log(TotalEditar);" class="icono">
  ...
  <q-dialog v-model="card">
    <q-card class="my-card">
      ...
      <q-card-actions align="right">
        <q-btn @click="agregarDevolucionEntrada(); showBtn = false" v-show="showBtn == true" v-close-popup flat
          color="primary" label="Agregar" />
